...
function getCourses()
{
    return [
        [
            'id' => 1,
            'title' => I18n::t('course.list') . ' A',
            'desc' => I18n::t('course.list') . ' A',
            'teacher' => 'Teacher A',
            'price' => 299,
            'original_price' => 499,
            'students' => 1234,
        ...
        [
            'id' => 2,
            'title' => I18n::t('course.list') . ' B',
            'desc' => I18n::t('course.list') . ' B',
            'teacher' => 'Teacher B',
            'price' => 599,
            'original_price' => 899,
            'students' => 876,
        ...
        [
            'id' => 3,
            'title' => I18n::t('course.list') . ' C',
            'desc' => I18n::t('course.list') . ' C',
            'teacher' => 'Teacher C',
            'price' => 1299,
            'original_price' => 1999,
            'students' => 432,
        ...
        [
            'id' => 4,
            'title' => I18n::t('course.list') . ' D',
            'desc' => I18n::t('course.list') . ' D',
            'teacher' => 'Teacher D',
            'price' => 0,
            'original_price' => 0,
            'students' => 5678,
